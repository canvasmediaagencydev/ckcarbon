  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        {/* Charcoal Heap */}
        <div
          className="absolute bottom-0 right-0 w-[900px] h-[500px] bg-contain bg-no-repeat opacity-30"
          style={{
          ...
          >
            ...
            >
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600">2004</div>
                <div className="text-sm text-gray-600 mt-1">ก่อตั้ง</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 mt-1">ธรรมชาติ</div>
              </div>
            </motion.div>
          </motion.div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex items-center justify-center space-x-4">
                      ...
                      >
                        ...
                        <span className="text-xs text-gray-600">Coconut Shell</span>
                      </motion.div>
                      ...
                      >
                        ...
                        <span className="text-xs text-gray-600">Activated Carbon</span>
                      </motion.div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 pt-6 border-t border-gray-100">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm text-gray-700">High-Quality Filtration</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-sm text-gray-700">Eco-Friendly Production</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-sm text-gray-700">Industrial & Household Use</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-sm text-gray-700">Trusted Partnership</span>
                    </div>
                  </div>
                </div>
              </motion.div>
